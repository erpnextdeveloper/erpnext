...
def get_posting_date(i):
		
		p_date=frappe.db.sql("""select posting_date from `tabStock Ledger Entry` where voucher_type="Purchase Receipt" and item_code=%s order by posting_date desc limit 1""",i)
		if p_date:
			return p_date[0][0]
